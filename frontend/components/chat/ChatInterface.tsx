  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 relative">
      ...
      <button
        ...
        className="fixed bottom-36 sm:bottom-8 right-4 w-14 h-14 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center z-[60] touch-target group"
